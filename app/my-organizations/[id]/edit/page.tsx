...
export default function EditOrganizationPage() {
  ...
  const organization = user?.organizations.find(org => org.organizationId === orgId);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center py-12 px-4 bg-gray-50">
          <div className="bg-white p-8 rounded shadow text-center">
            ...
            <p className="mb-4">The organization you are trying to edit does not exist or you do not have access.</p>
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-gray-600">Update your organization details below</p>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-6">Edit the information below</p>
